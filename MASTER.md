# Business Purchase — Master Document

> **Living source of truth for the acquisition project**  
> Last updated: **2026-08-22**  
> Status: **Active search / off-market sourcing**
...
Preferred businesses have most of the following characteristics:

- Recognized Canadian brand.
...
1. **Spirits / Canadian whisky / established alcoholic beverage brands**
   - Long-lived brands and products.
   - Strong potential strategic buyer universe.
   - Distribution can be highly valuable.
   - Tariff disruption may create unusually motivated sellers.

2. **Food & beverage CPG**
   - Evergreen consumption.
   - Repeat purchases.
   - Brand equity and shelf placement can create defensibility.
   - Potential for channel, geography, SKU, and manufacturing optimization.

### Tier 2 — Attractive

3. **Sporting / outdoor goods**
   - Especially branded businesses with meaningful U.S. distribution.
   - Prefer consumable, replacement, recurring, enthusiast, or category-leading products.

4. **Specialty branded consumer products**
   - Strong history and brand awareness.
   - Good distribution.
   - Product remains relevant over long periods.
   - Clear strategic acquirer universe.

### Lower interest / avoid unless exceptional
...
3. Other Canadian provinces — consider selectively for exceptional opportunities

Cross-border sales exposure is desirable when that exposure is the reason the seller is currently under pressure.
...
- 100% acquisition.
- Founder or family succession.
- Off-market transaction.
- Corporate carve-out.
- Recapitalization involving a motivated owner.
- Distressed-but-solvent acquisition.
- Lender-driven or covenant-pressure situation before formal insolvency.
...
6. Buyers value the company on current earnings rather than normalized earnings.
...
1. **Senior accountants and partners at respected accounting firms**
   - Audit partners with private-company portfolios.
   - Corporate finance / M&A partners.
   - Transaction advisory partners.
   - Restructuring and turnaround partners.
   - Tax partners serving founder-owned businesses.
   - Private enterprise / family business leaders.

2. **Commercial and corporate bankers**
   - Relationship managers with owner-operated businesses.
   - Special loans / workout groups.
   - Mid-market lenders.
...
- quietly open to a transaction before hiring an investment banker.

Initial emphasis should include major firms such as **KPMG** plus other Big Four and strong Canadian/mid-market firms with substantial Quebec and Ontario private-company practices.
...
A concise **one-page buyer profile** should be used for referral partners.
...
- Fraud or unreliable financial reporting.
- Unsustainable customer concentration.
- Severe environmental liability.
- Unmanageable product liability.
- Brand impairment that appears permanent.
- Large hidden capex requirement.
...
- Maintenance capex.
- Debt capacity.
- Seller-financing capacity.
- Downside liquidation / asset value where relevant.
...
Every tariff-affected target should have a specific bridge quantifying:

**Pre-tariff EBITDA**  
→ lost volume  
→ tariff cost  
→ pricing response  
→ distributor/customer concessions  
→ FX impact  
→ sourcing changes  
→ other operating changes  
→ **current EBITDA**

This prevents tariffs from becoming a vague explanation for unrelated deterioration.
...
- Revenue by customer, geography, channel, and SKU.
- U.S. versus Canadian revenue.
- Customer retention and order trends.
- Distribution agreements.
- Retail shelf placement and velocity where applicable.
...
- Monthly results for the latest 24–36 months.
...
- HTS classification and tariff rates.
- Which party contractually bears tariffs.
- U.S. distributor economics before and after tariffs.
- Lost accounts or reduced orders attributable to tariffs.
- Ability to move production or final assembly.
- Country-of-origin rules.
- Alternative sourcing.
- Potential exemptions.
- Canadian and non-U.S. growth alternatives.
...
1. Identified
2. Initial research
3. Referral path found
4. Contacted
5. NDA / information requested
6. Initial financial review
7. Management / owner discussion
8. IOI
9. LOI
10. Due diligence
11. Financing
...
### After initial sourcing

- [ ] Contact the highest-probability referral partners first.
...
After any material research, sourcing, target review, financial analysis, outreach decision, or change in acquisition strategy, update this file so that it reflects the latest state of the project.

When information becomes large enough to justify a separate supporting file, keep the key decision, status, and link/reference in `MASTER.md` so this document remains the project index and executive source of truth.
